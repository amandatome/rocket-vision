...
if (!function_exists('theme_setup')) :
	...
	*  sizes with add_image_size. */
		...
		add_image_size('member', 250, 250, true);
		add_image_size('rectangle', 300, 500, true);
...
{
	$query_args = array(
		'family' => 'Barlow:400|Playfair+Display:900',
...
{
	return ' <a href="' . get_permalink() . '"><br><button class="read-more">Read More</button> </a>';
}
...
{
	echo '<a href="' . get_permalink(get_option('page_for_posts')) . '" rel="nofollow">Blog</a>';
